...
def stream_of_entity_with_metrics (entities, metrics, verbose, skipLibraries,regex_str_ignore_item, regex_str_traverse_files, regex_ignore_files ):
    for entity in entities:
        ...
        if "CountDeclMethodNonStub" in metric_dict:
            ...
            metric_dict["CountDeclMethodNonStub"] = extra_metrics.get("CountDeclMethod",0) - (2 * extra_metrics.get("CountDeclPropertyAuto",0)) # note we can't always multiply by 2 (not always a getter and setter) but this is the best we can do
